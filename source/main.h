...
public:
	PhosphorFrame(uint32_t frame_width, uint32_t frame_height, double fps_delta, double rp22_short, double gp22_short, double bp22_short, double rp22_long, double gp22_long, double bp22_long, bool old_primaries, bool multithreading);
	~PhosphorFrame();
